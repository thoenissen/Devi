...
public class TemporaryComponentsContainer<TIdentification> : TemporaryComponentsContainer
{
    ...
    {
        System.Threading.Tasks.Task.Delay(60_000, _cancellationTokenSource.Token).ContinueWith(obj => _taskSource.TrySetException(new DiscordTimeoutException()), _cancellationTokenSource.Token);
    }
